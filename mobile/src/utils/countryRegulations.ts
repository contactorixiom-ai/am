...
export const COUNTRY_SUMMARIES: CountrySummary[] = [
  ...
  { code: 'ML', name: 'Mali',              zone: 'AFRICA_WEST', currency: 'XOF', trackingType: 'BSC',  authority: 'CMTR' },
  { code: 'BF', name: 'Burkina Faso',      zone: 'AFRICA_WEST', currency: 'XOF', trackingType: 'BSC',  authority: 'CBC' },
  { code: 'NE', name: 'Niger',             zone: 'AFRICA_WEST', currency: 'XOF', trackingType: 'ECTN', authority: 'CNUT' },
  { code: 'BJ', name: 'Bénin',             zone: 'AFRICA_WEST', currency: 'XOF', trackingType: 'ECTN', authority: 'CNCB' },
  { code: 'TG', name: 'Togo',              zone: 'AFRICA_WEST', currency: 'XOF', trackingType: 'ECTN', authority: 'CNCT' },
  { code: 'GN', name: 'Guinée',            zone: 'AFRICA_WEST', currency: 'GNF', trackingType: 'ECTN', authority: 'CNCG' },
  { code: 'GW', name: 'Guinée-Bissau',     zone: 'AFRICA_WEST', currency: 'XOF', trackingType: 'ECTN', authority: 'Douanes' },
  { code: 'SL', name: 'Sierra Leone',      zone: 'AFRICA_WEST', currency: 'SLE', trackingType: 'ECTN', authority: 'SLMA' },
  { code: 'LR', name: 'Liberia',           zone: 'AFRICA_WEST', currency: 'LRD', trackingType: 'ECTN', authority: 'LSC' },
  ...
  { code: 'CF', name: 'République Centrafricaine',      zone: 'AFRICA_CENTRAL', currency: 'XAF', trackingType: 'BESC',  authority: 'BARC' },
  { code: 'TD', name: 'Tchad',                          zone: 'AFRICA_CENTRAL', currency: 'XAF', trackingType: 'BESC',  authority: 'CNUT' },
  ...
  { code: 'SD', name: 'Soudan',         zone: 'AFRICA_EAST', currency: 'SDG', trackingType: 'ECTN',  authority: 'Sudan Shippers Council' },
  ...
  { code: 'ZW', name: 'Zimbabwe',        zone: 'AFRICA_SOUTH', currency: 'USD', trackingType: null,         authority: 'ZIMRA' },
  ...
  { code: 'AO', name: 'Angola',          zone: 'AFRICA_SOUTH', currency: 'AOA', trackingType: 'CARGO_WAIVER', authority: 'AGT/CNC' },
